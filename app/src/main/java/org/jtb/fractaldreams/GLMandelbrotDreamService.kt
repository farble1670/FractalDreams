...
class GLMandelbrotDreamService : DreamService() {
    private companion object {
        const val OVERLAY_UPDATE_MS = 100L  // Update overlay every 100ms
        const val RENDER_SCALE = 2  // Render at 1/2 resolution (4x fewer pixels)
    }
    ...
    private class ScaledGLSurfaceView(context: Context, private val scale: Int) : GLSurfaceView(context) {
